export const API = {
  ...
  ADMIN: {
    ...
    GET_ALL_BUSINESSES: "/api/admin/businesses",
    GET_USER: (id: string) => `/api/admin/users/${id}`,
    UPDATE_USER: (id: string) => `/api/admin/users/${id}`,
    DELETE_USER: (id: string) => `/api/admin/users/${id}`,
    GET_BUSINESS: (id: string) => `/api/admin/businesses/${id}`,
    APPROVE_BUSINESS: (id: string) => `/api/admin/businesses/${id}/approve`,
    REJECT_BUSINESS: (id: string) => `/api/admin/businesses/${id}/reject`,
