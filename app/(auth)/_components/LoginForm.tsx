    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-sm mx-auto p-6 md:p-8">
        ...
        <div className="text-right mb-8">
          ...
          <Link href="#" className="text-red-600 text-base font-crimsonPro font-normal hover:underline">
            Forgot password?
          </Link>
        </div>
        ...
        <div className="flex justify-center mt-6 text-lg font-crimsonPro">
          ...
          <span className="text-gray-500 font-normal">Don't have an account?</span>

          <Link href="/signup" className="text-red-600 font-medium ml-2 hover:underline">
            Signup!
          </Link>
        </div>
      </form>
